...
<div class="page-wrapper">
    ...
    <div class="admin-quick-links">
        <a href="/ums/admin/users.php"    class="quick-link">👥 Manage Users</a>
        <a href="/ums/admin/listings.php" class="quick-link">📦 Manage Listings</a>
        <a href="/ums/admin/reports.php"  class="quick-link">⚑ View Reports
    ...
    <div class="admin-two-col">
        ...
        <div class="admin-section">
            ...
            <a href="/ums/admin/listings.php" class="see-all">See all listings →</a>
        </div>
        ...
        <div class="admin-section">
            ...
            <a href="/ums/admin/users.php" class="see-all">See all users →</a>
        </div>
